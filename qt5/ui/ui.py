...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(463, 709)
        MainWindow.setStyleSheet("background-color: #262829;")
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.frame = QtWidgets.QFrame(self.centralwidget)
        self.frame.setGeometry(QtCore.QRect(0, 0, 720, 251))
        self.frame.setStyleSheet("background-color: #EB4C42;")
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.label = QtWidgets.QLabel(self.frame)
        self.label.setGeometry(QtCore.QRect(10, 10, 451, 51))
        font = QtGui.QFont()
        ...
        self.label_2.setGeometry(QtCore.QRect(140, 60, 181, 171))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("./ui/exchange.png"))
        self.label_2.setObjectName("label_2")
        self.input_currency = QtWidgets.QLineEdit(self.centralwidget)
        self.input_currency.setGeometry(QtCore.QRect(70, 270, 321, 61))
        font = QtGui.QFont()
        ...
        self.input_currency.setStyleSheet("background-color: #262829;\n"
...
"color: white;")
        ...
        self.input_amount.setGeometry(QtCore.QRect(70, 360, 321, 61))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.input_amount.setStyleSheet("background-color: #262829;\n"
"border: 2px solid #EB4C42;\n"
"border-radius: 30;\n"
"color: white;")
        ...
        self.output_amount.setGeometry(QtCore.QRect(70, 540, 321, 61))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.output_amount.setStyleSheet("background-color: #262829;\n"
"border: 2px solid #EB4C42;\n"
"border-radius: 30;\n"
"color: white;")
        ...
        self.output_currency.setGeometry(QtCore.QRect(70, 450, 321, 61))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.output_currency.setStyleSheet("background-color: #262829;\n"
"border: 2px solid #EB4C42;\n"
"border-radius: 30;\n"
"color: white;")
        ...
        self.pushButton.setGeometry(QtCore.QRect(70, 630, 321, 61))
        font = QtGui.QFont()
